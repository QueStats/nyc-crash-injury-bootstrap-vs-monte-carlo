...
results_file <- paste0("results/bootstrap_results_", seed, ".rds")
...
# =============================================================================
# FIGURES 1--4 -- Exploratory data analysis
# =============================================================================

fig("fig1_hist_injuries", width = 600, height = 500)
h <- hist(y, breaks = 0:16 - 0.5, plot = FALSE)
barplot(h$counts + 1, log = "y", col = "gray", border = "white",
        names.arg = h$mids,
...
boxplot(y ~ borough_labels,
        ...
        xlab = "Borough", ylab = "Persons Injured",
        las = 2, col = "lightgray")
dev.off()
cat("Figure 3 saved.\n")
...
plot(y_hat, y,
     ...
     xlab = "Predicted Values", ylab = "Observed Persons Injured",
...
# =============================================================================
# TABLE 2 -- Real-data coefficients
# =============================================================================
...
write.csv(table2, "tables/table2_real_data_coefficients.csv",
          row.names = FALSE)
cat("Table 2 saved.\n")
...
write.csv(table3_out, "tables/table3_parametric_inference.csv",
          row.names = FALSE)
cat("Table 3 saved.\n")

# =============================================================================
# TABLE 4 -- Bootstrap inference and comparison to parametric inference
# =============================================================================

table4_out <- bootstrap_summary
table4_out[, -1] <- round(table4_out[, -1], 6)
write.csv(table4_out, "tables/table4_bootstrap_inference.csv",
          row.names = FALSE)
cat("Table 4 saved.\n")

# =============================================================================
# FIGURES 6--8 -- Bootstrap sampling distributions
# =============================================================================
...
hist(beta_boot[, "Night"],
     ...
     xlab = "Bootstrap Estimate", col = "lightgray", border = "black",
     breaks = floor(sqrt(N)))
...
plot(bootstrap_summary$Parametric_SE, bootstrap_summary$Bootstrap_SE,
     main = "Figure 9: Parametric SE vs Bootstrap SE",
     xlab = "Parametric Standard Error",
     ylab = "Bootstrap Standard Error",
     pch = 19)
abline(0, 1, col = "red", lwd = 2)
text(bootstrap_summary$Parametric_SE, bootstrap_summary$Bootstrap_SE,
     labels = bootstrap_summary$Parameter, pos = 4, cex = 0.65)
dev.off()
cat("Figure 9 saved.\n")
...
hist(rmse_boot,
     ...
     xlab = "Bootstrap RMSE", col = "lightgray", border = "black",
     breaks = floor(sqrt(N)))
...
yield_row <- bootstrap_summary[bootstrap_summary$Parameter == "FailureToYield", ]
